...
- The globe texture and library are loaded from a CDN (unpkg) at runtime, so an internet connection is required to use the app (the airport dataset itself is local/offline once generated).
